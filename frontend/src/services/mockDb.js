...
const CLIENT_NAME = (function(){ const u = SEED_USERS.find(x=>x.mode==='client'); return u ? u.name : 'Cliente'; })();
...
export const mockDb = {
  ...
  createOrder(serviceId) {
    ...
    const newOrder = {
      ...
      client_id: 1,
      worker_id: 2,
      client_name: (function(){ const u = SEED_USERS.find(x=>x.id===1); return u ? u.name : 'Cliente'; })(),
      worker_name: 'Bruno Silva',
